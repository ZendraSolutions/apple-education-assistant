# Índice Visual - Documentación Jamf Assistant
...
│  ✓ Guías paso a paso, checklists y diagnósticos             │
│  ✓ Chatbot con IA (introducción)                            │
│  ✓ Consejos: tema oscuro, atajos, instalar en iPad          │
│                                                              │
│  [LEER MANUAL] → USER_GUIDE.md                              │
└─────────────────────────────────────────────────────────────┘
```
...
│  ────────────────────────────────────────────────────────   │
│  Archivo: FAQ.md                                            │
│  Duración: ~10 minutos (o busca tu pregunta específica)     │
│  Nivel: Todos                                               │
│                                                              │
│  Categorías:                                                 │
│  • General (¿Qué es? ¿Necesito instalar? ¿Funciona offline?)│
│  • Chatbot IA (API Key, seguridad, límites)                 │
│  • Problemas comunes (15+ soluciones)                       │
│  • Privacidad y datos                                       │
...
│  ────────────────────────────────────────────────────────   │
│  Archivo: API_KEY_SETUP.md                                  │
│  Duración: 5-10 minutos (proceso completo)                  │
│  Nivel: Fácil (paso a paso con capturas de texto)           │
│                                                              │
│  Pasos detallados:                                           │
...
│  4. Copiar la clave                                         │
│  5. Pegar en Jamf Assistant                                 │
│  6. Guardar configuración                                   │
│  7. Verificar que funciona                                  │
│                                                              │
│  Incluye: Tips de seguridad, solución de problemas          │
│                                                              │
...
│  Contenido:                                                  │
│  • Principios SOLID                                         │
│  • Arquitectura del sistema (40+ módulos ES6)               │
│  • Patrones de diseño (IoC, Registry, Chain, Strategy)      │
│  • Estructura de capas                                      │
...
1. [FAQ.md](FAQ.md) - "El chatbot no responde" (5 causas y soluciones)
2. [API_KEY_SETUP.md](API_KEY_SETUP.md) - "Qué hacer si no funciona"

### No puedo instalar en iPad
1. [FAQ.md](FAQ.md) - "No puedo instalar en iPad"
2. [USER_GUIDE.md](USER_GUIDE.md) - "Instalar en iPad (PWA)"

### No encuentro algo en la búsqueda
1. [FAQ.md](FAQ.md) - "La búsqueda no encuentra resultados"
2. Usa el chatbot IA como alternativa
...
│
├─ 2. [USER_GUIDE.md](USER_GUIDE.md) - Secciones 1-2 (10 min)
│    └─ Introducción + Primeros Pasos
│
└─ 3. Explorar la app (15 min)
     └─ Navegar, probar búsquedas, ver guías

Día 2: Configuración del Chatbot
├─ 1. [API_KEY_SETUP.md](API_KEY_SETUP.md) (10 min)
│    └─ Configurar API Key paso a paso
│
└─ 2. [USER_GUIDE.md](USER_GUIDE.md) - Sección 4 (5 min)
     └─ Chatbot con IA

Cuando surja una duda:
└─ [FAQ.md](FAQ.md) - Buscar pregunta específica (2-5 min)
```

### Para IT/Desarrolladores

```
Semana 1: Comprensión del Sistema
├─ 1. [README.md](README.md) (5 min)
│    └─ Vista general
│
...
- [Google AI Studio](https://aistudio.google.com/apikey) (para API Key)
...
- v1.0.0 (Dic 2024): Creación inicial de documentación de usuario
  ...
  - API_KEY_SETUP.md: Guía paso a paso de configuración
  - README.md: Índice de navegación
  - INDEX.md: Este índice visual
...
**Desarrolladores**: Consulta [ARCHITECTURE.md](ARCHITECTURE.md) para información de contacto del equipo de desarrollo.
